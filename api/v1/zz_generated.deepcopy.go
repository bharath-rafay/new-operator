...
func (in *NamespacedDeployments) DeepCopyInto(out *NamespacedDeployments) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespacedDeployments.
func (in *NamespacedDeployments) DeepCopy() *NamespacedDeployments {
	if in == nil {
		return nil
	}
	out := new(NamespacedDeployments)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScalerSpec) DeepCopyInto(out *ScalerSpec) {
	*out = *in
	if in.Deployments != nil {
		...
		*out = make([]NamespacedDeployments, len(*in))
		copy(*out, *in)
	}
}
