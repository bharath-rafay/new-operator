...
func (in *HealthCheckStatus) DeepCopyInto(out *HealthCheckStatus) {
	*out = *in
	if in.ServicesStatus != nil {
		...
		*out = make([]ServiceHealthStatus, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceHealth) DeepCopyInto(out *ServiceHealth) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceHealth.
func (in *ServiceHealth) DeepCopy() *ServiceHealth {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceHealthStatus) DeepCopyInto(out *ServiceHealthStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceHealthStatus.
func (in *ServiceHealthStatus) DeepCopy() *ServiceHealthStatus {
	if in == nil {
		return nil
	}
	out := new(ServiceHealthStatus)
	in.DeepCopyInto(out)
	return out
}
