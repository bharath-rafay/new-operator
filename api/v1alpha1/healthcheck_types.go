...
// ServiceHealth defines the custom services to monitor
...
type HealthCheckStatus struct {
	...
	ServicesStatus   []ServiceHealthStatus `json:"servicesStatus,omitempty"`
}

// ServiceHealthStatus defines the observed state of a service
